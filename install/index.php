...
<head>
    ...
    <title>Software Install Wizard By Baboolsoft</title>
    <!-- <link rel="stylesheet" href="../assets/frontend/css/line-awesome.min-v1.0.3.css"> -->
                    ...
                    <div class="form-outer-wrapper">
                        ...
                        <form id="msform" action="index.php" method="post">
                            ...
                            <div class="content-wrap with-step">
                                <h4>Upload Your Database Here</h4>

                                <input id="fileUpload" type="file" name="file" required />

                                <input type="button" class="action-button" id="upload-button" value="Upload" />
                                <button type="submit" class="next action-button hide" id="next_page"> NEXT</button>
                            </div>
                            <div class="content-wrap with-step">
...
if ($phpversion == true) {
    print '<div class="icon check"><i class="las la-check-circle" aria-hidden="true"></i></div>';
} else {
    print '<div class="icon close"><i class="las la-times-circle" aria-hidden="true"></i></div>';
}
?>
                                            </td>
                                        </tr>
...
?>
                                        <tr>
                                            ...
                                            <td>Required <strong><?php echo ucwords($ext); ?></strong> PHP Extension
                                            </td>
                                            <td>
                                                <?php
...
?>
                                ...
                                <?php if ($ext_errors > 0): ?>
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">contact your
                                    hosting provider to install or enable
                                    <strong><?php echo implode(',', $ext_list); ?></strong> php extensions</div>
                                <?php endif;?>
                                <button type="button" class="previous action-button">Previous</button>
                                <button type="button" class="next action-button" <?php if ($ext_errors > 0): ?> disabled
                                    <?php endif;?>>
                                    Next
                                </button>
                            </div>
...
foreach ($folders as $ext): ?>
                                        <tr>
                                            <td><strong><?php echo str_replace('../', '', ucwords($ext)); ?></strong>
                                            </td>
...
?>
                                ...
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">give permission
                                    0755 to <strong><?php echo implode(', ', $fol_list); ?></strong> folder</div>
                                <?php endif;?>
                                <button type="button" class="previous action-button">Previous</button>
                                <button type="button" class="next action-button" <?php if ($folder_errors > 0): ?>
                                    disabled <?php endif;?>>
                                    Next
                                </button>
                            </div>
                            <div class="content-wrap with-step">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Required
                                                 ...
                                                 <p id="dbavailable" value=""></p>
                                                  <!-- <input id="dbavailable" value=""/> -->
                                                  available
                                ...
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">your
                                    installation<strong><?php echo $db; ?>
                                    </strong> file is missing, reupload files </div>
                                <?php endif;?> -->
                                <button type="button" class="previous action-button">Previous</button>
                            ...
                            <div class="content-wrap with-step">
                                ...
                                <button type="button" class="previous action-button"
                                    id="last_previous">Previous</button>
                                <button type="button" class="action-button" id="check_database">Check Databse
                                    Connection</button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-inner">
                        &copy; 2021 All Right Reserved By<a href="https://baboolsoft.com">Baboolsoft</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function ($) {
            ...
            $(document).on('click', ".previous", function (e) {
                ...
                $("#progressbar li").eq($(".content-wrap.with-step").index(current_fs)).removeClass(
                    "active");
            ...
            $(document).on('click', '#upload-button', function (e) {
                ...
                // console.log("len",file.files.length);
                // console.log("len",$('#fileUpload')[0].files.length);
                ...
                if (file == undefined) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo home_base_url(); ?>install/upload.php",
                        data: formData,
                        contentType: false,
                        processData: false,
                        ...
                        success: function (data) {
                            //  $("#upload-button").prop('disabled', true);
                             ...
                             $("#next_page").show();
                             $("#dbavailable").append(file.name);
                            //  $('#upload-button').preventDefault();
                ...
                if (validateDatabaseField()) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#message_show').html('<div class="alert alert-' + data.type +
                                '">' + data.msg + '</div>');
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (index, value) {
                                ...
                                if (value.type == 'success') {
                                    $('#install_now').hide()
                                    $('#install_now').addClass('show').removeClass(
                                        'hide');
                                }
                            });
                        }
            ...
            function validateAdminField() {
                ...
                allField.forEach(function (value, index) {
                    if ($(value).val() == '') {
                        ...
                        $(value).parent().append('<span class="error-text">' + $(value).parent().find(
                            'label').text() + ' is required</span>');
                    } else {
  ...
  function validateFileField() {
                ...
                if ($('#file')[0].files.length === 0) {
                    ...
                    $(file).parent().find('.error-text').remove();
                    $(file).parent().append('<span class="error-text">' + $(file).parent().find('label')
